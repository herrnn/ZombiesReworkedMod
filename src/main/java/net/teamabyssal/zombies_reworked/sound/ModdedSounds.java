...
public class ModdedSounds {
    ...
    public static final RegistryObject<SoundEvent> ZOMEBIE_HORDE_SPAWN = registerSoundEvents("zombie_horde_spawn");

    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name, () -> new SoundEvent(new ResourceLocation(ZombiesReworked.MODID, name)));
    }
